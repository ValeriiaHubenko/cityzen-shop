...
const Home = () => (
    ...
    <div className="h-screen card" style={{ overflowX: "hidden" }}>
      <video
        ...
        muted
      ></video>
        <div className="absolute inset-0 h-[794px] bg-black opacity-50 rounded-[50px] card"></div>

        <div className="relative z-10 pt-10">
        <h1 className="lg:text-[78px] sm:text-[32px] lg:pt-0 sm:pt-20 lg:pb-0 sm:pb-3 text-center text-white font-semibold font-chillax">
        Discover the <span className="text-pink">Zen</span> in Urban Living</h1>
        <p className="text-white lg:text-3xl sm:text-xl font-regular font-chillax text-center mt-1"> Innovative, Unique, Stylish & Practical Decor Items</p>

        <div className="flex justify-center mt-60">
          <Link href="/products#productsrange" className="w-[220px] h-20 flex justify-center items-center border-4 border-dashed border-white rounded-full bg-pink/85  text-white text-2xl font-medium font-chillax capitalize hover:bg-pink active:bg-pink lg:mt-0 sm:-mt-5">Shop Now</Link>
          </div>
    ...
    <div className="w-full h-[820px] bg-white rounded-[50px] card">
    <div className="text-black lg:text-[28px] font-medium font-chillax text-center lg:w-[922px] sm:[320px] mx-auto pt-20 m-14 leading-relaxed">
    ...
    <div className="w-full h-[500px] flex lg:flex-row sm:flex-col gap-5 justify-center">
    ...
    loop
    muted />
    <div className="flex flex-col gap-5 lg:visible sm:invisible">
    ...
    loop
    muted />
    <video className="w-60 h-60 bg-black rounded-3xl object-cover lg:visible sm:invisible" 
    ...
    <div className="flex flex-col items-left justify-center lg:gap-12 sm:gap-5">
    ...
    <div className="w-full h-[750px] bg-white rounded-[50px] z-0 card">
    <div className="text-black text-[38px] font-semibold font-chillax text-center pt-[90px] pb-5">Innovative <span className="text-pink font-semibold">Smart</span> Home Decor</div>
    
    <img className="absolute inset-x-0 mt-36 pt-2 z-0" src="public/images/Vector 1.png" alt="line" />

    <div className="flex lg:flex-row sm:flex-col gap-28 mx-20 relative z-0">
    ...
    <div className="flex flex-col gap-4 items-center mt-[75px]">
