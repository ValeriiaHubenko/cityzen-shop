...
const ProductsRange = ({ selectedCategory }) => {
  ...
  return (
    ...
    {displayedProducts.map((product, index) => (
        ...
        className="flex flex-col gap-4 justify-start relative group p-2 h-full w-full"
        ...
        >
          ...
          <Card className="my-card">
            <CardTitle className="my-card-title">{product.title}</CardTitle>
            <CardDescription className="my-card-description">{product.price}</CardDescription>
          </Card>
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-lightgray font-bold tracking-wide mt-4", className)}>
      {children}
    </h4>
  );
};
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "mt-8 text-lightgray tracking-wide leading-relaxed text-sm",
        className
      )}
    >
      {children}
